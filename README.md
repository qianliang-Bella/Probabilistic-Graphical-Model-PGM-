...
### find out the Probability of G1,G2,G2 given low IQ and high IQ  over the difficulties
### find out the Probability of G1,G2,G2 given the IQs
### adding all probabilities to get L1 given all possibilities of G1,G2,G3.  
...
### compute the Probability of getting G3 of low and high IQ over d0 and d1 
### compute the probability of getting G3 over i0 and i1 
### compute the probability of i1 given G3
...
## Q3
### P(i1|g3,s1)= p(g3,s1|i1) * p(i1) / p(g3,s1) = 0.578
